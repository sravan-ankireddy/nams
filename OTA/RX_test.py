...
# Title: USRP test
# Author: Sravan Ankireddy
# GNU Radio version: v3.11.0.0git-432-gd5478261
...
class RX_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0_0.set_bandwidth((2*samp_rate), 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/sa53869/work/nams/OTA/TX.bin', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/sa53869/work/nams/OTA/RX_gnu.bin', False)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq, (2*self.samp_rate))
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.freq, (2*self.samp_rate))
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate)
        self.uhd_usrp_sink_0.set_samp_rate(self.samp_rate)
        self.uhd_usrp_sink_0.set_bandwidth((2*self.samp_rate), 0)
        self.uhd_usrp_source_0_0.set_samp_rate(self.samp_rate)
        self.uhd_usrp_source_0_0.set_bandwidth((2*self.samp_rate), 0)
