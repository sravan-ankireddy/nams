...
if args.dev_type == "encoder":
    ...
    cmd_string = (
        "python3 /home/rajesh/sravan_ra/nams/OTA/FeedbackAll/Python/Automation/TX_flow_graph_TX.py -tx_gain "
        + str(args.tx_gain)
        + " -file_path "
        + args.tx_filename
    )
    ...
    if args.fdbk == "noisy":
        ...
        for i in range(N_captures):
            ...
            print("Capture :", i + 1, "...")
            cmd_string = (
                "python3 /home/rajesh/sravan_ra/nams/OTA/FeedbackAll/Python/Automation/TX_flow_graph_RX.py -rx_gain "
                + str(args.rx_gain)
                + " -file_path "
                + args.rx_filename
            )
    ...
    for i in range(N_captures):
        print("Capture :", i + 1, "...")
        cmd_string = (
            "python3 /home/rajesh/sravan_ra/nams/OTA/FeedbackAll/Python/Automation/TX_flow_graph_RX.py -nsamples 10000000 -rx_gain "
            + str(args.rx_gain)
            + " -file_path "
            + args.rx_filename
        )
