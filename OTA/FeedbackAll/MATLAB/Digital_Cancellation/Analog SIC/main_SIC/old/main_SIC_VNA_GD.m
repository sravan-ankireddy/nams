...
% run gradient descend for coefficient update 
...
small_w_size = 16*1;
w_size  = small_w_size*8; % size of windowing
...
[f_window_bsb, f_window_pass,f_idx_bsb,f_idx_pass] = cal_f_index_v2(f_start,BW,delta_f,NFFT);
...
if flag_load_ADC_capture == 1
    ...
    %filename = 'VNA_RS\data\20180418\echo.mat';  
...
[ht_bsb_w,idx_peak_small_w] = window_filter_down(ht_bsb,desired_peaks,f_window_bsb,w_size,fc,fs,OSR,flag_filter_only,small_w_size,flag_is_echo,idx_peak_small_w);
