...
% code_init = [3441,3480,2750,3500,3290,3777,3809];
...
%         disp(str);
        ...
        for sign_trial = [1,-1]
          ...
          figure(2);         
          subplot (2,1,1);
          histogram(Cancel_hist,20);grid on;
          xlabel('Cancelation (dB)');ylabel('Frequency');
          xlim([20 40]);
          axt1=gca;
          axt1.GridAlpha = 0.4;
          subplot(2,1,2);
         ...
         xlabel('Trials'); ylabel('Cancelation (dB)');grid on;
         grid on;
         axt=gca;
         axt.GridAlpha = 0.4;
