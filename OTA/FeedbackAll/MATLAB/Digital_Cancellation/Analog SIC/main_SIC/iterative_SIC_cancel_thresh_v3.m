...
cancel_hold = 0;
k = 1;
dim =[0.374508353221959 0.122294372294372 0.173224343675417 0.0703463203463204];
...
%         disp(str);
        ...
        for sign_trial = [1,-1]
            ...
            [df,f] = vna_measure_cm(app);
             dt    = ifft(df);
             Mag_t = lin2db(dt);
             Mag_t = [Mag_t(1:8) (to_pow_dB(echo_t(9:end))+ rand(1,length(echo_t(9:end))))];
