function [taps_f_out,taps_t_out,f] = read_VNA_complex_all_taps_test(f_window,flag_int)
...
if flag_int == 1 % internal taps  
    ...
    filename_real = 'data\VNA\20180214_1.2G\internal_2-14\marker1_real_imag.dat';
    [taps_f{1}, taps_t{1}, x] = read_VNA_compex_v2(filename_real);
    
    filename_real = 'data\VNA\20180214_1.2G\internal_2-14\marker2_real_imag.dat';
    [taps_f{2}, taps_t{2}, x] = read_VNA_compex_v2(filename_real);
    
    filename_real = 'data\VNA\20180214_1.2G\internal_2-14\marker3_real_imag.dat';
    [taps_f{3}, taps_t{3}, x] = read_VNA_compex_v2(filename_real);
    
    filename_real = 'data\VNA\20180214_1.2G\internal_2-14\marker4_real_imag.dat';
    [taps_f{4}, taps_t{4}, x] = read_VNA_compex_v2(filename_real);
    
    filename_real = 'data\VNA\20180214_1.2G\internal_2-14\marker5_real_imag.dat';
    [taps_f{5}, taps_t{5}, x] = read_VNA_compex_v2(filename_real);
    
    filename_real = 'data\VNA\20180214_1.2G\internal_2-14\marker6_real_imag.dat';
    [taps_f{6}, taps_t{6}, x] = read_VNA_compex_v2(filename_real);
    
    filename_real = 'data\VNA\20180214_1.2G\internal_2-14\marker7_real_imag.dat';
    [taps_f{7}, taps_t{7}, x] = read_VNA_compex_v2(filename_real);

    filename_real = 'data\VNA\20180214_1.2G\internal_2-14\marker8_real_imag.dat';
    [taps_f{8}, taps_t{8}, x] = read_VNA_compex_v2(filename_real);
