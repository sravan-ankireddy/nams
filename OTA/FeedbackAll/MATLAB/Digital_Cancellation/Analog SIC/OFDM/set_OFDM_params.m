function params = set_OFDM_params()
...
% params.NFFT   = 64; % FFT size 
% params.NCP    = 16; % cp size 
% params.N_data = 52; % number of data subcarriers 
