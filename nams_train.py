...
def save_weights(h, g, coding_scheme, channel_type, nn_eq, training_batch_size, lr, eb_n0_train_lo, eb_n0_train_hi, offline_tr_data, max_iter, steps, relu, adapt_tr, freeze_wt, ff, models):
	...
	+ " -eb_n0_train_lo " + eb_n0_train_lo + " -eb_n0_train_hi " + eb_n0_train_hi + " -eb_n0_step 1 -entangle_weights " + ent_index[0] +  \
	...
	-force_all_zero 0 -channel_type " + channel_type + " -nn_eq " + nn_eq + " -coding_scheme \
	" + coding_scheme + " -training_batch_size " + training_batch_size 
	+ " -eb_n0_train_lo " + eb_n0_train_lo + " -eb_n0_train_hi " + eb_n0_train_hi + " -eb_n0_step 1 -entangle_weights " + ent_index[1] +  \
	...
	-force_all_zero 0 -channel_type " + channel_type + " -nn_eq " + nn_eq + " -coding_scheme \
	" + coding_scheme + " -training_batch_size " + training_batch_size 
	+ " -eb_n0_train_lo " + eb_n0_train_lo + " -eb_n0_train_hi " + eb_n0_train_hi + " -eb_n0_step 1 -entangle_weights " + ent_index[2] +  \
	...
	# -force_all_zero 0 -channel_type " + channel_type + " -nn_eq " + nn_eq + " -coding_scheme \
	# " + coding_scheme + " -training_batch_size " + training_batch_size 
	# + " -eb_n0_train_lo " + eb_n0_train_lo + " -eb_n0_train_hi " + eb_n0_train_hi + " -eb_n0_step 1 -entangle_weights " + ent_index[3] +  \
